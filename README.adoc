...
kubectl create secret generic bigip-login --from-literal=username=cis_user --from-literal=password=default --from-literal=url=https://192.168.200.204 -n bigip-ctlr
