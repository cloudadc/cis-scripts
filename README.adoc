...
// upadate service, then record time
kubectl scale -n cistest9 deploy/app-3 --replicas=2
...
// upadate service, then record time
kubectl scale -n cistest29 deploy/app-3 --replicas=2

// delete service from BIG-IP, record time
kubectl apply -f configmap-filter-tenants/cm-30-svc.yaml

// resource release
kubectl scale -n cistest29 deploy/app-3 --replicas=1
----
...
// upadate service, then record time
kubectl scale -n cistest49 deploy/app-3 --replicas=2

// delete service from BIG-IP, record time
kubectl apply -f configmap-filter-tenants/cm-20-svc.yaml

// resource release
kubectl scale -n cistest49 deploy/app-3 --replicas=1
----
...
// upadate service, then record time
kubectl scale -n cistest69 deploy/app-3 --replicas=2
...
// upadate service, then record time
kubectl scale -n cistest89 deploy/app-3 --replicas=2

// delete service from BIG-IP, record time
kubectl apply -f configmap-filter-tenants/cm-90-svc.yaml

// resource release
kubectl scale -n cistest89 deploy/app-3 --replicas=1
----
